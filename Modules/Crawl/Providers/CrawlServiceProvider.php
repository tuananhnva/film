...
class CrawlServiceProvider extends ServiceProvider
{
    ...
    protected function registerConfig()
    {
        ...
        $this->mergeConfigFrom(
            __DIR__.'/../Config/config.php', 'crawl'
        );
    }
    ...
    {
        $viewPath = resource_path('views/modules/crawl');
        ...
        }, \Config::get('view.paths')), [$sourcePath]), 'crawl');
    }
    ...
    {
        $langPath = resource_path('lang/modules/crawl');
